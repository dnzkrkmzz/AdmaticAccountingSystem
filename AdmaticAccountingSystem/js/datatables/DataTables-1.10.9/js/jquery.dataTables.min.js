    ...
    var S = function (h) {
        ...
        "row().child().remove()"], function () { bb(this); return this }); p("row().child.isShown()", function () { var a = this.context; return a.length && this.length ? a[0].aoData[this[0]]._detailsShow || !1 : !1 }); var dc = /^(.+):(name|visIdx|visible)$/, Wb = function (a, b, c, d, e) { for (var c = [], d = 0, f = e.length; d < f; d++) c.push(B(a, e[d], b)); return c }; p("columns()", function (a, b) {
            ...
            fnStateSaveParams: null, iStateDuration: 7200, iDeferLoading: null, iDisplayLength: 10, iDisplayStart: 0, iTabIndex: 0, oClasses: {}, oLanguage: {
                oAria: { sSortAscending: ": activate to sort column ascending", sSortDescending: ": activate to sort column descending" }, oPaginate: { sFirst: "First", sLast: "Last", sNext: "Ileri", sPrevious: "Geri" }, sEmptyTable: "No data available in table", sInfo: "_TOTAL_ kayittan _START_ ile _END_ arasi gosteriliyor", sInfoEmpty: "0 kayittan 0 ile 0 arasi gosteriliyor", sInfoFiltered: "(filtered from _MAX_ total entries)",
                sInfoPostFix: "", sDecimal: "", sThousands: ",", sLengthMenu: "ilk _MENU_  kaydi goster", sLoadingRecords: "Loading...", sProcessing: "Processing...", sSearch: "Arama:", sSearchPlaceholder: "", sUrl: "", sZeroRecords: "No matching records found"
