...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "_TOTAL_ kayittan _START_ ile _END_ arasi gosteriliyor",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "_TOTAL_ kayittan _START_ ile _END_ arasi gosteriliyor",
			 ...
			 *    } );
			 */
			"sLengthMenu": "ilk _MENU_  kaydi goster",
	...
	$.extend( extPagination, {
		...
		simple_numbers: function ( page, pages ) {
			return [ 'Geri', _numbers(page, pages), 'Ileri' ];
		},
	
		full_numbers: function ( page, pages ) {
			return [ 'first', 'Geri', _numbers(page, pages), 'Ileri', 'last' ];
		},
